                ...
                <table class="table" id="dataTableExample">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="file-report-view" data-bs-toggle="modal" data-bs-target="#file-report-view" data-id="{{ $file->id }}" data-file_name="{{ $file->file_name }}" data-ai="{{ $file->ai }}" data-similarity="{{ $file->similarity }}" data-plagiarism_report="{{ $file->plagiarism_report }}" data-ai_report="{{ $file->ai_report }}">{{ $file->ai ? $file->ai . '%' : '-' }}</td>
                            <td class="file-report-view" data-bs-toggle="modal" data-bs-target="#file-report-view" data-id="{{ $file->id }}" data-file_name="{{ $file->file_name }}" data-ai="{{ $file->ai }}" data-similarity="{{ $file->similarity }}" data-plagiarism_report="{{ $file->plagiarism_report }}" data-ai_report="{{ $file->ai_report }}">{{ $file->similarity ? $file->similarity . '%' : '-' }}</td>
                            <td class="file-report-view" data-bs-toggle="modal" data-bs-target="#file-report-view" data-id="{{ $file->id }}" data-file_name="{{ $file->file_name }}" data-ai="{{ $file->ai }}" data-similarity="{{ $file->similarity }}" data-plagiarism_report="{{ $file->plagiarism_report }}" data-ai_report="{{ $file->ai_report }}">{{ $file->flags ? $file->flags . '%' : '-'}}</td>
                            <td >
                                @if($file->status == 0)
